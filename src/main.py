...
def parse_args():
    ...
    parser.add_argument('--ast_path', default='../data/assistments/', type=str, help='path to real assessment data directory')
    ...
    parser.add_argument('--use_dev', default=False, type=bool, help='n')

    # model type
    parser.add_argument('--model_type', default="LSTM", type=str, help='n')
    # model args (RNN)
    parser.add_argument('--input_type', default='onehot', type=str, help='n')
    parser.add_argument('--n_input_dim', default=100, type=int, help='n')
    parser.add_argument('--embedding_dim', default=100, type=int, help='c')
    parser.add_argument('--hidden_dim', default=200, type=int, help='c')
    parser.add_argument('--n_layers', default=1, type=int, help='number of RNN layers')
    ...
    parser.add_argument('--loss', default='BCE', type=str, help='n')
    parser.add_argument('--optim', default='adam', type=str, help='n')
    parser.add_argument('--lr', default=0.001, type=float, help='n')
    parser.add_argument('--momentum', default=0.9, type=float, help='n')
    parser.add_argument('--n_epochs', default=10, type=int, help='n')
    parser.add_argument('--clip_grad', default=100.0, type=float, help='n')
    parser.add_argument('--log_steps', default=10, type=int, help='n')

    # train : batch size
    parser.add_argument('--train_batch_size', default=100, type=int, help='n')
    parser.add_argument('--eval_batch_size', default=100, type=int, help='n')

    # train : save/load args
    parser.add_argument('--task', default='dkt', type=str, help='n')
    parser.add_argument('--save_model', default=False, type=bool, help='whether to save model')
    parser.add_argument('--save_dir', default="./../ckpt/", type=str, help='n')
    parser.add_argument('--save_epochs', default=10, type=int, help='save moodel for every n epochs')
    parser.add_argument('--load_dir', default="./../ckpt/", type=str, help='n')
    parser.add_argument('--load_model', default=False, type=bool, help='whether to load model')
    parser.add_argument('--load_epoch', default=30, type=int, help='')
    parser.add_argument('--refresh_optim', default=False, type=bool, help='n')
